    ...
    return (
      <div className="bg-[#0b0b12] min-h-screen text-white flex items-center justify-center px-[4%]">
        <div className="text-center">
          <h1 className="text-[clamp(1.5rem,3vw,2.5rem)] font-normal text-white mb-4">Blog Post not found</h1>
          <button
          ...
          >
            ← {t("insights_content.details.backToBlogs", "Back to Blogs")}
          </button>
        </div>
      </div>
    );
      ...
      <div className="relative z-10 w-full px-[4%] py-16 sm:py-20 md:py-28 flex flex-col gap-20 sm:gap-24 md:gap-28 max-w-[1400px] mx-auto">
        ...
        >
          ...
          >
            ...
            <div>
              <h3 className="text-lg md:text-xl font-normal text-white mb-0.5 tracking-tight">{post.author}</h3>
              <p className="text-lg md:text-xl text-white/40 leading-relaxed">{post.role}</p>
            </div>
          </motion.div>
        </motion.section>
      </div>
