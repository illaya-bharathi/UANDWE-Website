...
const BENEFITS_DATA = [
  {
    ...
    desc: "Premium medical, dental, and vision insurance for you and your dependents, ensuring peace of mind."
  },
  {
    icon: <TrendingUp size={28} />,
    title: "Competitive Compensation",
    desc: "We offer top-tier salaries, performance bonuses, and equity packages so you share in our success."
  },
  {
    icon: <Globe size={28} />,
    title: "Flexible Work",
    desc: "Work from where you thrive. We embrace hybrid and remote work models for optimal work-life balance."
  },
  {
    icon: <Heart size={28} />,
    title: "Mental Wellness",
    desc: "Access to premium mental health resources, counseling services, and regular wellness days off."
  },
  {
    icon: <BookOpen size={28} />,
    title: "Continuous Learning",
    desc: "Generous stipends for conferences, courses, and certifications to keep your skills sharp."
  },
  {
    icon: <Coffee size={28} />,
    title: "Office Perks",
    desc: "Fully stocked kitchens, catered lunches, and state-of-the-art equipment for your home or office setup."
  },
  {
    icon: <Sun size={28} />,
    title: "Unlimited PTO",
    desc: "Take the time you need to recharge. We believe in resting as hard as we work."
  },
  {
    icon: <Smile size={28} />,
    title: "Family First",
    desc: "Generous parental leave for all new parents, plus childcare stipends and family planning support."
  }
];
    ...
    <div className="bg-[#0b0b12] min-h-screen text-white pt-[120px] pb-24 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-[5%] relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-24">
          ...
          >
            Invested in <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff6b1a] to-orange-400">You</span>
          </motion.h1>
          ...
          >
            We believe that our people are our greatest asset. That's why we offer a comprehensive benefits package designed to support your physical, mental, and financial well-being.
          </motion.p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {BENEFITS_DATA.map((benefit, idx) => (
              ...
              >
                ...
                <p className="text-white/60 leading-relaxed text-sm relative z-10">{benefit.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-white/[0.02] border border-white/10 rounded-[3rem] p-10 md:p-20 relative overflow-hidden mb-32">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row gap-16 items-center">
            <div className="w-full lg:w-1/2">
              <h2 className="text-3xl md:text-5xl font-bold mb-6">More than just <span className="text-[#ff6b1a]">perks</span>.</h2>
              <p className="text-white/70 text-lg leading-relaxed mb-8">
                Our benefits philosophy goes beyond standard offerings. We aim to create an environment where you can do your best work without worrying about the essentials. From comprehensive health plans to supporting your continuous growth, we've got you covered.
              </p>
              <ul className="space-y-4">
                {['100% company-paid premiums for employees', 'Quarterly wellness stipends', 'Annual learning & development budget'].map((item, i) => (
                  <motion.li 
                    key={i}
        ...
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <p className="text-white/90 text-lg mb-10">
              Explore our open roles and find your next big opportunity with UANDWE.
            </p>
