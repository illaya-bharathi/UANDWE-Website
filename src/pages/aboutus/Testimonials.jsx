...
const TESTIMONIALS = [
  {
    id: 1,
    quote: "UANDWE didn't just deliver a chip; they delivered a competitive advantage. Their RTL and physical design teams executed flawlessly, ensuring our 5nm automotive ASIC taped out exactly on schedule with zero re-spins. Truly exceptional engineering.",
    author: "Mark Stevenson",
    role: "VP of Hardware Engineering",
    company: "AutoDrive Technologies",
    rating: 5,
    highlight: "Zero Re-spins on 5nm",
    image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&auto=format&fit=crop&q=80"
  },
  {
    id: 2,
    quote: "When we needed to overhaul our entire embedded Linux architecture for a fleet of 100,000 IoT devices, UANDWE was the only partner capable of handling the complexity. Their firmware is rock-solid and the OTA update mechanism is bulletproof.",
    author: "Dr. Elena Rostova",
    role: "Chief Technology Officer",
    company: "ConnectSphere IoT",
    rating: 5,
    highlight: "100k+ Devices Deployed",
    image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&auto=format&fit=crop&q=80"
  },
  {
    id: 3,
    quote: "The software team at UANDWE fundamentally transformed our backend infrastructure. By migrating our legacy monolith to a highly scalable cloud-native microservices architecture, they reduced our cloud costs by 40% while improving uptime.",
    author: "David Chen",
    role: "Director of Software",
    company: "FinTech Solutions Global",
    rating: 5,
    highlight: "40% Cloud Cost Reduction",
    image: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&auto=format&fit=crop&q=80"
  },
  {
    id: 4,
    quote: "Their hardware prototyping speed is unmatched. Within weeks, we had functional, high-speed HDI PCBs ready for validation. Their rigorous signal integrity analysis saved us months of debugging in the lab.",
    author: "Sarah O'Connor",
    role: "Hardware Architect",
    company: "NextGen Networks",
    rating: 5,
    highlight: "Accelerated Time-to-Market",
    image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&auto=format&fit=crop&q=80"
  },
  {
    id: 5,
    quote: "UANDWE is more than a vendor; they are a seamless extension of our internal team. The communication, transparency, and deep technical expertise they bring to every single sprint is simply phenomenal.",
    author: "Michael Chang",
    role: "Head of Product",
    company: "HealthSync Medical",
    rating: 5,
    highlight: "Seamless Team Integration",
    image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&auto=format&fit=crop&q=80"
  },
  {
    id: 6,
    quote: "The verification environment they built for our RISC-V core was incredibly robust. Their use of advanced UVM methodologies caught several critical corner-case bugs that our internal team had missed.",
    author: "Priya Patel",
    role: "Lead Verification Engineer",
    company: "Silicon Innovators Inc.",
    rating: 5,
    highlight: "100% Verification Coverage",
      ...
      <div className="max-w-[1400px] mx-auto px-[5%] relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-24">
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff6b1a] to-orange-400">Industry Leaders</span>
          </motion.h1>
          ...
          >
            Don't just take our word for it. Hear from the visionaries, CTOs, and engineering leaders who have partnered with UANDWE to turn their complex challenges into flawless realities.
          </motion.p>
        </div>
        ...
        >
          <div className="h-[400px] md:h-[600px] w-full relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <h3 className="text-2xl font-bold text-white text-center px-4">Watch: The AutoDrive Success Story</h3>
              <p className="text-white/70 mt-2">How we engineered a 5nm ASIC in record time</p>
            </div>
          </div>
        </motion.div>
              ...
              >
                ...
                <div className="bg-white/5 rounded-2xl p-4 mb-6 border border-white/10">
                  <div className="text-[#ff6b1a] text-xs font-bold uppercase tracking-wider mb-1 flex items-center gap-2">
                    <Building size={14} /> Key Impact
                  </div>
                  <div className="text-white font-medium text-sm">{testimonial.highlight}</div>
                </div>
                ...
                <div className="flex items-center gap-4 mt-auto border-t border-white/10 pt-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/40 text-xs mt-1">{testimonial.company}</p>
                  </div>
                </div>
              </motion.div>
            ))}
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-white/60 text-lg mb-10">
              Join the ranks of industry leaders who trust UANDWE to engineer their most critical technologies. Let's build the future together.
            </p>
