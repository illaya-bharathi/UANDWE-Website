...
const RAW_LEADERSHIP_TEAM = [
  ...
  },
  {
    ...
    defaultBio: "A pioneer in advanced VLSI architectures and embedded systems, Sarah leads our global R&D initiatives, ensuring UANDWE remains at the bleeding edge of engineering.",
  ...
  },
  {
    ...
    defaultBio: "Michael oversees all global hardware and software execution. He specializes in scaling high-performance engineering teams to deliver mission-critical projects.",
  ...
  },
  {
    ...
    defaultBio: "Elena optimizes our global delivery networks, ensuring seamless collaboration between our clients and distributed engineering teams across 15 timezones.",
  ...
  },
  {
    ...
    defaultBio: "David leads our AI & Data Science division, integrating intelligent automation and predictive modeling into enterprise-scale architectures.",
  ...
  },
  {
    ...
    defaultBio: "A verification guru, Priya manages the end-to-end ASIC design lifecycle, specializing in ultra-low power FinFET architectures.",
      ...
      <div className="max-w-[1400px] mx-auto px-[5%] relative z-10">
        ...
        >
          <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-white/70 text-sm font-medium mb-8">
            ...
            {t("aboutus.leadership.hero.badge", "Executive Leadership")}
          </motion.div>
          
          <motion.h1 variants={itemVariants} className="text-4xl md:text-5xl lg:text-7xl font-bold leading-tight mb-8">
            {t("aboutus.leadership.hero.titlePart1", "Guided by")} <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff6b1a] to-orange-400">{t("aboutus.leadership.hero.titlePart2", "Visionaries")}</span>
          </motion.h1>
          
          <motion.p variants={itemVariants} className="text-lg md:text-xl text-white/60 leading-relaxed">
            {t("aboutus.leadership.hero.description", "Our leadership team brings together decades of experience across semiconductor design, enterprise software, and global operations to steer UANDWE toward engineering perfection.")}
          </motion.p>
        </motion.div>
              ...
              >
                ...
                <div className="p-8 flex flex-col flex-grow bg-[#12121a] relative z-10 -mt-10">
                  ...
                  <div className="mt-auto pt-4 flex items-center justify-between opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <span className="text-white text-xs font-semibold uppercase tracking-widest">{t("aboutus.leadership.connect", "Connect")}</span>
        ...
        <div className="bg-white/[0.02] border border-white/5 rounded-[3rem] p-10 md:p-20 relative overflow-hidden mb-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10">
            <div>
              <SectionHeading 
                titlePart1={t("aboutus.leadership.philosophy.titlePart1", "Our Leadership")} 
                titlePart2={t("aboutus.leadership.philosophy.titlePart2", "Philosophy")} 
                className="mb-8"
              />
              <p className="text-white/60 text-lg leading-relaxed mb-8">
                {t("aboutus.leadership.philosophy.description", "We believe that great engineering happens when brilliant minds are given the autonomy to innovate and the resources to succeed. Our leaders don't just manage; they roll up their sleeves, mentor the next generation, and foster an environment where technical excellence is the default standard.")}
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="bg-[#12121a] p-8 rounded-3xl border border-white/10">
                <div className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#ff6b1a] to-orange-400 mb-4">
                  {t("aboutus.leadership.philosophy.box1Val", "60+")}
                </div>
                <div className="text-white font-bold mb-2">
                  {t("aboutus.leadership.philosophy.box1Title", "Years Combined Experience")}
                </div>
                <p className="text-white/50 text-sm leading-relaxed">
                  {t("aboutus.leadership.philosophy.box1Desc", "Our board brings unmatched historical knowledge of the semiconductor and software industries.")}
                </p>
              </div>
              <div className="bg-[#12121a] p-8 rounded-3xl border border-white/10 mt-0 sm:mt-12">
                <div className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400 mb-4">
                  {t("aboutus.leadership.philosophy.box2Val", "100%")}
                </div>
                <div className="text-white font-bold mb-2">
                  {t("aboutus.leadership.philosophy.box2Title", "Engineering Backgrounds")}
                </div>
                <p className="text-white/50 text-sm leading-relaxed">
                  {t("aboutus.leadership.philosophy.box2Desc", "Every executive has hands-on experience designing the technologies we build today.")}
                </p>
              </div>
            </div>
          </div>
