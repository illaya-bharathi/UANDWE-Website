...
const SEQUENCE_FEATURES = [
    { id: 1, title: "Rapid Prototype Development", desc: "Accelerate product innovation with fast and reliable hardware prototype development." },
    { id: 2, title: "Functional Hardware Validation", desc: "Validate core functionalities, interfaces, and system performance before mass production." },
    { id: 3, title: "Embedded System Integration", desc: "Seamlessly integrate processors, sensors, displays, and communication modules into working prototypes." },
    { id: 4, title: "Prototype Testing & Debugging", desc: "Identify and resolve hardware issues through comprehensive testing, analysis, and optimization." },
    { id: 5, title: "Design Optimization", desc: "Refine hardware designs to improve performance, manufacturability, and product reliability." },
    { id: 6, title: "Production Readiness", desc: "Transform validated prototypes into manufacturing-ready hardware solutions with confidence." }
];
    ...
    return (
        <ServiceLayout 
            hero={{
                ...
                description: "Rapid transition from concept to tangible prototypes, ensuring design viability before mass production.",
