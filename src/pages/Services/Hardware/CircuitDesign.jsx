...
const SEQUENCE_FEATURES = [
    { id: 1, title: "Precision Circuit Engineering", desc: "Design high-performance analog and digital circuits optimized for reliability and efficiency." },
    { id: 2, title: "Intelligent Power Solutions", desc: "Develop efficient power management circuits for low-power, battery-operated, and high-performance systems." },
    { id: 3, title: "Mixed-Signal Design", desc: "Seamlessly integrate analog and digital circuitry for complex embedded and electronic products." },
    { id: 4, title: "Signal Integrity Optimization", desc: "Ensure clean, stable, and noise-free signal transmission across critical circuit paths." },
    { id: 5, title: "Reliability-Centric Design", desc: "Engineer robust circuits with enhanced protection, fault tolerance, and long-term operational stability." },
    { id: 6, title: "Design Verification & Validation", desc: "Validate circuit functionality through simulation, analysis, and comprehensive testing before production." }
];
    ...
    return (
        <ServiceLayout 
            hero={{
                ...
                description: "Precision analog, digital, and mixed-signal circuit design tailored to your exact system requirements.",
