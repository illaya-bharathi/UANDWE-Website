...
const SEQUENCE_FEATURES = [
    { id: 1, title: "High-Speed PCB Design", desc: "Design high-performance PCBs optimized for DDR, PCIe, USB, Ethernet, HDMI, and other high-speed interfaces." },
    { id: 2, title: "Multi-Layer PCB Engineering", desc: "Develop complex multi-layer PCB layouts with HDI technology, controlled impedance, and optimized stack-ups." },
    { id: 3, title: "Signal & Power Integrity", desc: "Ensure reliable signal transmission and stable power delivery through advanced SI/PI analysis and optimization." },
    { id: 4, title: "Thermal & Power Optimization", desc: "Design efficient thermal solutions using optimized component placement, copper balancing, and heat dissipation techniques." },
    { id: 5, title: "Design for Manufacturing (DFM)", desc: "Create production-ready PCB layouts that maximize manufacturability, assembly efficiency, and product reliability." },
    { id: 6, title: "Quality & Compliance", desc: "Deliver PCB designs that comply with IPC standards while ensuring performance, reliability, and long-term maintainability." }
];
    ...
    return (
        <ServiceLayout 
            hero={{
                ...
                description: "High-speed, multi-layer, and dense Printed Circuit Board designs tailored for robust manufacturing and optimal signal integrity.",
