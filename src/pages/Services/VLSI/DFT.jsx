...
const SEQUENCE_FEATURES = [
    { id: 1, title: "Scan Insertion", desc: "Implementing muxed-D scan chains to provide high fault coverage." },
    { id: 2, title: "ATPG Generation", desc: "Automatic Test Pattern Generation for stuck-at, transition, and path-delay faults." },
    { id: 3, title: "Memory BIST (MBIST)", desc: "Integrating Built-In Self-Test logic to rapidly detect SRAM/ROM failures." },
    { id: 4, title: "Logic BIST (LBIST)", desc: "Self-testing random logic for safety-critical automotive applications (ISO 26262)." },
    { id: 5, title: "Boundary Scan (JTAG)", desc: "IEEE 1149.1 compliant tap controllers for board-level interconnect testing." },
    { id: 6, title: "Fault Simulation", desc: "Rigorous grading to ensure target test coverage > 99% is achieved." }
];
    ...
    return (
        <ServiceLayout 
            hero={{
                ...
                description: "Architecting robust test infrastructures to ensure manufacturing defects are caught before reaching the customer.",
