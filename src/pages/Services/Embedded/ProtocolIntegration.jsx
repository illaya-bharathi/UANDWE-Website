...
const SEQUENCE_FEATURES = [
    { id: 1, title: "Multi-Protocol Expertise", desc: "Integrate industry-standard communication protocols across embedded, industrial, automotive, and IoT platforms." },
    { id: 2, title: "Seamless Device Communication", desc: "Enable reliable data exchange between sensors, controllers, gateways, cloud platforms, and connected devices." },
    { id: 3, title: "High-Performance Communication", desc: "Optimize protocol stacks for low latency, high throughput, and deterministic communication." },
    { id: 4, title: "Secure Data Transmission", desc: "Implement encrypted communication, authentication, and secure data exchange across connected systems." },
    { id: 5, title: "Custom Protocol Development", desc: "Design and implement proprietary communication protocols tailored to unique hardware and application requirements." },
    { id: 6, title: "Cross-Platform Compatibility", desc: "Ensure interoperability across embedded platforms and third-party systems." }
];
    ...
    return (
        <ServiceLayout 
            hero={{
                ...
                description: "Connecting devices to the world with robust implementation of industrial, automotive, and IoT communication protocols.",
