...
const SEQUENCE_FEATURES = [
    { id: 1, title: "Real-Time Performance", desc: "Develop deterministic real-time applications with guaranteed response times for mission-critical embedded systems." },
    { id: 2, title: "Deterministic Task Scheduling", desc: "Implement priority-based scheduling and task management to ensure predictable system behavior." },
    { id: 3, title: "Efficient Multithreading", desc: "Design scalable multi-threaded applications with synchronized task execution and optimized resource sharing." },
    { id: 4, title: "Optimized Memory Management", desc: "Utilize static allocation, memory pools, and efficient resource management for reliable embedded systems." },
    { id: 5, title: "Advanced Debugging & Trace", desc: "Accelerate development with RTOS-aware debugging, execution tracing, and real-time performance analysis." },
    { id: 6, title: "Reliable & Scalable RTOS Solutions", desc: "Build robust RTOS applications using FreeRTOS, Zephyr, ThreadX, VxWorks, and other industry-leading platforms." }
];
    ...
    return (
        <ServiceLayout 
            hero={{
                ...
                description: "Deterministic, real-time operating systems tailored for mission-critical applications where every microsecond counts.",
