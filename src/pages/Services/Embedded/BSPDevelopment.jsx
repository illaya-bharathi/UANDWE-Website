...
const SEQUENCE_FEATURES = [
    { id: 1, title: "Board Bring-Up Expertise", desc: "Accelerate hardware enablement from initial power-on to a fully functional embedded platform." },
    { id: 2, title: "BSP Customization", desc: "Develop and customize Board Support Packages tailored to your processor, peripherals, and product requirements." },
    { id: 3, title: "Bootloader Engineering", desc: "Configure and optimize U-Boot and other bootloaders for secure, reliable, and efficient system startup." },
    { id: 4, title: "Hardware Enablement", desc: "Enable seamless integration of processors, memory, communication interfaces, sensors, and peripheral devices." },
    { id: 5, title: "Hardware Validation & Testing", desc: "Perform comprehensive validation to ensure system stability, compatibility, and production readiness." },
    { id: 6, title: "Long-Term BSP Maintenance", desc: "Provide continuous BSP updates, kernel upgrades, bug fixes, and support throughout the product lifecycle." }
];
    ...
    return (
        <ServiceLayout 
            hero={{
                ...
                description: "Complete hardware bring-up and custom BSPs to get your proprietary custom boards running smoothly from day one.",
