...
const SEQUENCE_FEATURES = [
    { id: 1, title: "Yocto Project", desc: "Custom recipes, layers, and fully reproducible image builds." },
    { id: 2, title: "Kernel Patching", desc: "Modifying the Linux kernel for custom hardware and real-time (PREEMPT_RT)." },
    { id: 3, title: "RootFS Optimization", desc: "Stripping down the filesystem to minimize boot time and footprint." },
    { id: 4, title: "Secure Boot", desc: "Implementing hardware root-of-trust and encrypted filesystems." },
    { id: 5, title: "Device Tree Overlays", desc: "Dynamic hardware configuration via DTS/DTB modifications." },
    { id: 6, title: "Systemd & Init", desc: "Optimized boot sequences and custom service management." }
];
    ...
    return (
        <ServiceLayout 
            hero={{
                ...
                description: "Custom, highly optimized Linux distributions for embedded systems using Yocto and Buildroot.",
